package FileHandling.EmployeeManagement.FileDB;

import java.io.File;
import java.io.FileReader;
import java.io.FileWriter;
import java.io.IOException;
import FileHandling.EmployeeManagement.Model.EmpModel;

public class fdb {
    // Add Employee to the FDB
    public String addEmp(EmpModel model) {
        File file = new File("FileHandling/EmployeeManagement/FileDB/fdb.txt");
    ...
    public String deleteEmployee(String id) {
        if(getAllData().contains(id)) {
            ...
            try {
                FileWriter writer = new FileWriter(new File("FileHandling/EmployeeManagement/FileDB/fdb.txt"));
                StringBuffer sb = new StringBuffer();
                for (String s : arr) {
                    if(!s.contains(id)) {
