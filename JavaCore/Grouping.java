...
public class Grouping {
    ...
    static {
        EmployeeGroup eg1 = new EmployeeGroup("LK", "Trainer", 100000);
        EmployeeGroup eg12 = new EmployeeGroup("Kowsi", "Trainer", 100000);
        EmployeeGroup eg2 = new EmployeeGroup("Pree", "Tester", 12345);
        EmployeeGroup eg3 = new EmployeeGroup("V pri", "Developer", 1000);
        EmployeeGroup eg4 = new EmployeeGroup("Buva", "Tester", 344444);
        EmployeeGroup eg5 = new EmployeeGroup("Teju", "Developer", 50000);
